...
{ 
    public sealed partial class Capsule : Page
    {
        public Capsule()
        {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            RadiusSlider.Value = App.Setting.CapsuleRadius;
            RadiusNumberPicker.Value = (int)App.Setting.CapsuleRadius;

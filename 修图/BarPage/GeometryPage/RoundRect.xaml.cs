...
{ 
    public sealed partial class RoundRect : Page
    {
        public RoundRect()
        {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            RadiusSlider.Value = App.Setting.RoundRectRadius;
            RadiusNumberPicker.Value = (int)App.Setting.RoundRectRadius;
            RadiusSlider.ValueChanged += RadiusSlider_ValueChanged;
            RadiusNumberPicker.ValueChange += RadiusNumberPicker_ValueChange;
        ...
        {
            App.Setting.RoundRectRadius = (int)e.NewValue;
            RadiusNumberPicker.Value = (int)e.NewValue;
        }
        private void RadiusNumberPicker_ValueChange(object sender, int Value)
        {
            App.Setting.RoundRectRadius = Value;
